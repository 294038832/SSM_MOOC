...
public class DocumentAction {
    ...
    public ModelAndView getAllDocuments(String id) throws Exception{
        ModelAndView modelAndView = new ModelAndView();
        int nid = Integer.parseInt(id.split("-")[1]);
        documentService.removeDocumentsById(nid);
        modelAndView.setViewName("/documentQuery.html");
        return modelAndView;
    }
